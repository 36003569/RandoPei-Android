...
public class FinParcours extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fin_parcours);
    ...
    public void saveData(){
        ...
        editor.putFloat(FINPARCOURS_LAT, (float) latitude);
        editor.putFloat(FINPARCOURS_LON, (float) longitude);
        editor.commit();
