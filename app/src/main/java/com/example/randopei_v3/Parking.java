...
public class Parking extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void saveData(){
        ...
        // si on fait pas de try catch exception l'activité crash si la position n'est pas encore chargé.
        // à rajouter sur les autres activités
        try {
            latitude = gLocation.getLatitude();
            longitude = gLocation.getLongitude();
            editor.putFloat(PARKING_LAT, (float) latitude);
            editor.putFloat(PARKING_LON, (float) longitude);
            editor.commit();
            Toast.makeText(this, latitude+" , "+longitude, Toast.LENGTH_SHORT).show();
        }catch (Exception e){
            Toast.makeText(this, "Chargement de la position. Veuillez patientez!", Toast.LENGTH_SHORT).show();
        }
